...
\restrict fCfZIKYktiWdNM5icJ4gOP89PHYmCwknfWtvzcktdaLeed746alLzyt4CcX5mfk

-- Dumped from database version 16.13
-- Dumped by pg_dump version 16.13

-- Started on 2026-05-31 21:44:37
...
-- Name: estado_apuesta; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.estado_apuesta OWNER TO postgres;
...
-- Name: estado_participacion; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.estado_participacion OWNER TO postgres;
...
-- Name: estado_retiro; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.estado_retiro OWNER TO postgres;
...
-- Name: tipo_fraude; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.tipo_fraude OWNER TO postgres;

--
-- TOC entry 954 (class 1247 OID 17466)
-- Name: tipo_transaccion; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.tipo_transaccion OWNER TO postgres;

--
-- TOC entry 284 (class 1255 OID 17792)
-- Name: cfg_num(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.cfg_num(p_clave character varying) OWNER TO postgres;

--
-- TOC entry 285 (class 1255 OID 17793)
-- Name: cfg_txt(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.cfg_txt(p_clave character varying) OWNER TO postgres;

--
-- TOC entry 287 (class 1255 OID 17795)
-- Name: fn_calcular_cuota(numeric); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.fn_calcular_cuota(p_probabilidad_pct numeric) OWNER TO postgres;

--
-- TOC entry 5265 (class 0 OID 0)
-- Dependencies: 287
-- Name: FUNCTION fn_calcular_cuota(p_probabilidad_pct numeric); Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Name: fn_crear_saldo_bienvenida(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.fn_crear_saldo_bienvenida() OWNER TO postgres;

--
-- TOC entry 291 (class 1255 OID 17802)
-- Name: fn_finalizar_apuesta_al_confirmar(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.fn_finalizar_apuesta_al_confirmar() OWNER TO postgres;

--
-- TOC entry 288 (class 1255 OID 17796)
-- Name: fn_preview_apuesta(numeric, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.fn_preview_apuesta(p_monto numeric, p_opcion_id uuid) OWNER TO postgres;

--
-- TOC entry 5266 (class 0 OID 0)
-- Dependencies: 288
-- Name: FUNCTION fn_preview_apuesta(p_monto numeric, p_opcion_id uuid); Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Name: fn_recalcular_tendencia(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.fn_recalcular_tendencia() OWNER TO postgres;
...
-- Name: sp_abonar_saldo_admin(uuid, uuid, numeric, text); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_abonar_saldo_admin(IN p_admin_id uuid, IN p_usuario_id uuid, IN p_monto numeric, IN p_motivo text, OUT p_mensaje text) OWNER TO postgres;

--
-- TOC entry 312 (class 1255 OID 17816)
-- Name: sp_ajuste_saldo_admin(uuid, uuid, numeric, text); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_ajuste_saldo_admin(IN p_admin_id uuid, IN p_usuario_id uuid, IN p_monto numeric, OUT p_mensaje text, IN p_descripcion text) OWNER TO postgres;

--
-- TOC entry 314 (class 1255 OID 25562)
-- Name: sp_cambiar_estado_usuario(uuid, uuid, character varying, text); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_cambiar_estado_usuario(IN p_admin_id uuid, IN p_usuario_id uuid, IN p_accion character varying, IN p_motivo text, OUT p_mensaje text) OWNER TO postgres;

--
-- TOC entry 315 (class 1255 OID 25563)
-- Name: sp_cancelar_apuesta(uuid, uuid); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_cancelar_apuesta(IN p_usuario_id uuid, IN p_apuesta_id uuid, OUT p_mensaje text) OWNER TO postgres;

--
-- TOC entry 311 (class 1255 OID 17815)
-- Name: sp_cerrar_apuestas_expiradas(); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_cerrar_apuestas_expiradas(OUT p_total_cerradas integer) OWNER TO postgres;

--
-- TOC entry 309 (class 1255 OID 17811)
-- Name: sp_confirmar_resultado(uuid, uuid, boolean, text); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_confirmar_resultado(IN p_admin_id uuid, IN p_resultado_id uuid, IN p_aprobar boolean, OUT p_mensaje text, IN p_motivo_rechazo text) OWNER TO postgres;

--
-- TOC entry 306 (class 1255 OID 17808)
-- Name: sp_crear_apuesta(uuid, character varying, text, text[], numeric[], numeric, timestamp without time zone, numeric); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_crear_apuesta(IN p_creador_id uuid, IN p_titulo character varying, IN p_descripcion text, IN p_opciones text[], IN p_probabilidades numeric[], IN p_monto_minimo numeric, IN p_fecha_finalizacion timestamp without time zone, OUT p_apuesta_id uuid, OUT p_mensaje text, IN p_monto_maximo numeric) OWNER TO postgres;

--
-- TOC entry 319 (class 1255 OID 25589)
-- Name: sp_crear_categoria(uuid, text, text, text); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_crear_categoria(IN p_admin_id uuid, IN p_nombre text, IN p_descripcion text, IN p_icono text, OUT p_mensaje text, OUT p_categoria_id uuid) OWNER TO postgres;

--
-- TOC entry 318 (class 1255 OID 25570)
-- Name: sp_deducir_saldo_admin(uuid, uuid, numeric, text); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_deducir_saldo_admin(IN p_admin_id uuid, IN p_usuario_id uuid, IN p_monto numeric, IN p_motivo text, OUT p_mensaje text) OWNER TO postgres;

--
-- TOC entry 305 (class 1255 OID 17807)
-- Name: sp_gestionar_login(uuid, boolean, inet, text); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_gestionar_login(IN p_usuario_id uuid, IN p_exitoso boolean, IN p_ip_address inet, IN p_user_agent text, OUT p_bloqueado boolean, OUT p_mensaje text) OWNER TO postgres;

--
-- TOC entry 308 (class 1255 OID 17809)
-- Name: sp_participar_apuesta(uuid, uuid, uuid, numeric); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_participar_apuesta(IN p_usuario_id uuid, IN p_apuesta_id uuid, IN p_opcion_id uuid, IN p_monto numeric, OUT p_part_id uuid, OUT p_ganancia_si_gana numeric, OUT p_cuota_aplicada numeric, OUT p_mensaje text) OWNER TO postgres;

--
-- TOC entry 316 (class 1255 OID 25568)
-- Name: sp_proponer_resultado(uuid, uuid, uuid); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_proponer_resultado(IN p_creador_id uuid, IN p_apuesta_id uuid, IN p_opcion_ganadora_id uuid, OUT p_resultado_id uuid, OUT p_mensaje text) OWNER TO postgres;

--
-- TOC entry 310 (class 1255 OID 17812)
-- Name: sp_recargar_saldo(uuid, numeric, character varying, character); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_recargar_saldo(IN p_usuario_id uuid, IN p_monto numeric, IN p_metodo character varying, OUT p_mensaje text, IN p_ultimos_4 character) OWNER TO postgres;

--
-- TOC entry 304 (class 1255 OID 17806)
-- Name: sp_registrar_usuario(character varying, character varying, character varying, date, character varying, character varying, character varying, character varying); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_registrar_usuario(IN p_nombre character varying, IN p_apellido_paterno character varying, IN p_apellido_materno character varying, IN p_fecha_nacimiento date, IN p_telefono character varying, IN p_alias character varying, IN p_correo character varying, IN p_password_hash character varying, OUT p_usuario_id uuid, OUT p_mensaje text) OWNER TO postgres;

--
-- TOC entry 313 (class 1255 OID 17814)
-- Name: sp_revisar_documento(uuid, uuid, boolean, text); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_revisar_documento(IN p_admin_id uuid, IN p_documento_id uuid, IN p_aprobar boolean, OUT p_mensaje text, IN p_motivo_rechazo text) OWNER TO postgres;

--
-- TOC entry 307 (class 1255 OID 17813)
-- Name: sp_solicitar_retiro(uuid, numeric, character varying); Type: PROCEDURE; Schema: public; Owner: postgres
--
...
ALTER PROCEDURE public.sp_solicitar_retiro(IN p_usuario_id uuid, IN p_monto_solicitado numeric, IN p_metodo_retiro character varying, OUT p_retiro_id uuid, OUT p_mensaje text) OWNER TO postgres;
...
-- Name: documentos_identidad; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.documentos_identidad OWNER TO postgres;

--
-- TOC entry 5268 (class 0 OID 0)
-- Dependencies: 219
-- Name: TABLE documentos_identidad; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 219
-- Name: COLUMN documentos_identidad.numero_documento; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Name: intentos_fraude; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.intentos_fraude OWNER TO postgres;
...
-- Name: opciones_apuesta; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.opciones_apuesta OWNER TO postgres;

--
-- TOC entry 5270 (class 0 OID 0)
-- Dependencies: 222
-- Name: COLUMN opciones_apuesta.probabilidad_pct; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 222
-- Name: COLUMN opciones_apuesta.cuota; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 223
-- Name: COLUMN participaciones.ganancia_proyectada; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 223
-- Name: COLUMN participaciones.ganancia; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Name: recargas; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.recargas OWNER TO postgres;

--
-- TOC entry 5274 (class 0 OID 0)
-- Dependencies: 226
-- Name: TABLE recargas; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Name: resultados_apuesta; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.resultados_apuesta OWNER TO postgres;

--
-- TOC entry 5275 (class 0 OID 0)
-- Dependencies: 224
-- Name: TABLE resultados_apuesta; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 220
-- Name: TABLE saldos; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 225
-- Name: TABLE transacciones; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Dependencies: 218
-- Name: COLUMN usuarios.intentos_fallidos; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Name: v_apuestas_activas; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.v_apuestas_activas OWNER TO postgres;

--
-- TOC entry 5280 (class 0 OID 0)
-- Dependencies: 230
-- Name: VIEW v_apuestas_activas; Type: COMMENT; Schema: public; Owner: postgres
--
...
-- Name: v_documentos_pendientes; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.v_documentos_pendientes OWNER TO postgres;

--
-- TOC entry 234 (class 1259 OID 17836)
-- Name: v_fraudes_pendientes; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.v_fraudes_pendientes OWNER TO postgres;

--
-- TOC entry 232 (class 1259 OID 17826)
-- Name: v_historial_participaciones; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.v_historial_participaciones OWNER TO postgres;

--
-- TOC entry 237 (class 1259 OID 25590)
-- Name: v_ranking_semanal; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.v_ranking_semanal OWNER TO postgres;

--
-- TOC entry 231 (class 1259 OID 17822)
-- Name: v_saldo_usuario; Type: VIEW; Schema: public; Owner: postgres
--
...
ALTER VIEW public.v_saldo_usuario OWNER TO postgres;
...
-- Dependencies: 219
-- Data for Name: documentos_identidad; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 229
-- Data for Name: intentos_fraude; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 235
-- Data for Name: logs_admin; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 222
-- Data for Name: opciones_apuesta; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 226
-- Data for Name: recargas; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 224
-- Data for Name: resultados_apuesta; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Name: documentos_identidad documentos_identidad_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: documentos_identidad documentos_identidad_usuario_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: intentos_fraude intentos_fraude_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: opciones_apuesta opciones_apuesta_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: recargas recargas_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: resultados_apuesta resultados_apuesta_apuesta_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: resultados_apuesta resultados_apuesta_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: retiros retiros_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: saldos saldos_usuario_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: documentos_identidad uq_numero_documento; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: participaciones uq_usuario_opcion; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: idx_apuestas_activas; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_apuestas_creador; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_apuestas_estado; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_apuestas_fecha_fin; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_apuestas_tendencia; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_docs_estado; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_docs_numero; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_docs_usuario; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_fraude_sin_rev; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_fraude_tipo; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_fraude_usuario; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_login_fecha; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_login_ip; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_login_usuario; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_opciones_apuesta_id; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_part_apuesta; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_part_estado; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_part_opcion; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_part_usuario; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_recargas_usuario; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_resultados_apuesta; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_resultados_estado; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_retiros_usuario; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_saldos_usuario; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_tx_referencia; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: idx_usuarios_alias; Type: INDEX; Schema: public; Owner: postgres
--
...
-- Name: apuestas trg_apuestas_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--
...
-- Name: resultados_apuesta trg_finalizar_en_confirmacion; Type: TRIGGER; Schema: public; Owner: postgres
--
...
-- Name: usuarios trg_saldo_bienvenida; Type: TRIGGER; Schema: public; Owner: postgres
--
...
-- Name: participaciones trg_tendencia; Type: TRIGGER; Schema: public; Owner: postgres
--
...
-- Name: apuestas apuestas_categoria_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: apuestas apuestas_creador_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: documentos_identidad documentos_identidad_revisado_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: documentos_identidad documentos_identidad_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: intentos_fraude intentos_fraude_revisado_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: intentos_fraude intentos_fraude_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: intentos_login intentos_login_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: logs_admin logs_admin_admin_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: logs_admin logs_admin_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: opciones_apuesta opciones_apuesta_apuesta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: participaciones participaciones_apuesta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: participaciones participaciones_opcion_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: participaciones participaciones_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: recargas recargas_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: resultados_apuesta resultados_apuesta_apuesta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: resultados_apuesta resultados_apuesta_confirmado_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: resultados_apuesta resultados_apuesta_opcion_ganadora_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: resultados_apuesta resultados_apuesta_propuesto_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: retiros retiros_procesado_por_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: retiros retiros_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: saldos saldos_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Completed on 2026-05-31 21:44:37

--
-- PostgreSQL database dump complete
--

\unrestrict fCfZIKYktiWdNM5icJ4gOP89PHYmCwknfWtvzcktdaLeed746alLzyt4CcX5mfk
